...
//
// Bits defined in DWCMSHC_EMMC_DLL_STRBIN
//

#define DWCMSHC_EMMC_DLL_STRBIN_DLYENA               (1 << 27)
#define DWCMSHC_EMMC_DLL_STRBIN_DELAY_NUM_SEL        (1 << 26)
#define DWCMSHC_EMMC_DLL_STRBIN_DELAY_NUM_SHIFT      16
#define DWCMSHC_EMMC_DLL_STRBIN_DELAY_NUM_DEFAULT    0x10
