...
#pragma code_seg("PAGE")
NTSTATUS
CsAudioRk3xPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a CSAUDIORK3X_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    CSAUDIORK3X_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    CSAUDIORK3X_PROPERTY_ITEM* item = (CSAUDIORK3X_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
