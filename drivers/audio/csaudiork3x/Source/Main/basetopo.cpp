...
CMiniportTopologyCsAudioRk3x::CMiniportTopologyCsAudioRk3x
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCsAudioRk3x::GetDescription
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyCsAudioRk3x::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioRk3x::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioRk3x::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioRk3x::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyCsAudioRk3x::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyCsAudioRk3x::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyCsAudioRk3x::GenerateEventList]"));
