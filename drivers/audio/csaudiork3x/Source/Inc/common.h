...
#ifndef _CSAUDIORK3X_COMMON_H_
#define _CSAUDIORK3X_COMMON_H_
...
//
//=============================================================================
typedef struct _CSAUDIORK3X_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} CSAUDIORK3X_DEVPROPERTY, PCSAUDIORK3X_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with CSAUDIORK3X.<TopoName>.szPname in the inf's [Strings] section
    ...
    const CSAUDIORK3X_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with CSAUDIORK3X.<WaveName>.szPname in the inf's [Strings] section
    ...
    const CSAUDIORK3X_DEVPROPERTY*       WaveInterfaceProperties;
